...
template <> struct TypeUtils<half2> {
...
template <> struct TypeUtils<half4> {
  static constexpr int kElementsPerScalar = 2;
...
template <> struct TypeUtils<half8> {
  static constexpr int kElementsPerScalar = 2;
...
template <> struct Value2Index<half2> { typedef short2 Index; };

template <> struct Value2Index<half4> { typedef short4 Index; };

template <> struct Value2Index<half8> { typedef short8 Index; };
